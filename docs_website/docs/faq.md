...
Yes, AxiomHive Assistant is free and open-source. There are no usage costs, subscription fees, or API charges. All processing happens locally on your device.
...
1. **λ Core**: Constitutional enforcement engine using formal logic and Z3 SMT solver
2. **Φ Layer**: Generative AI with quantized Mistral-7B model and sparse activation
...
Yes, AxiomHive Assistant is open source under a proprietary license that protects the constitutional AI technology while allowing free use.
...
The application itself is free for personal and commercial use. Commercial licensing may be required for certain deployments or modifications.
