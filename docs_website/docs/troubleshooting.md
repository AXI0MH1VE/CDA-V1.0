...
ls -la models/
# Should see: mistral-7b-4bit.gguf, embeddings.gguf
...
2. Verify λ Core initialization
...
- Monitor λ/Φ compute ratio (<1% is good)
...
ls models/
# Expected: mistral-7b-4bit.gguf, embeddings.gguf
