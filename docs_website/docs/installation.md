...
2. **Embedding Model** (~100MB)
   ...
   - File: `model.onnx` or GGUF equivalent
   - Place as: `models/embeddings.gguf`

#### Alternative Download Method

If direct downloads are slow, use the provided download script:

```bash
# From the axiomhive-assistant directory
...
EMBEDDING_MODEL_PATH=./models/embeddings.gguf
